    ...
    <div className="page-grid two-up">
      <Panel title={t("dashboard.title")} description={t("dashboard.description")}>
        <div className="stat-grid">
          ...
          <div className="stat-card">
            <span>{t("dashboard.storedResults")}</span>
            <strong>{metrics.storedResults}</strong>
          </div>
          <div className="stat-card">
            <span>{t("dashboard.voices")}</span>
          ...
          <div className="stat-card">
            <span>{t("dashboard.failedJobs")}</span>
        ...
        <div className="panel-subheader-row">
          ...
          <button type="button" className="ghost-button compact-button" onClick={onOpenProjects}>
          ...
          {projects.slice(0, 6).map((project) => (
            ...
            >
              ...
              <div className="mini-metrics">
                ...
                <span>
                  {project.stats.succeeded_jobs} {t("dashboard.ok")}
                </span>
                <span>
                  {project.stats.failed_jobs} {t("dashboard.fail")}
                </span>
              </div>
            </button>
          ))}
      ...
      <Panel
        ...
        actions={
          <button type="button" className="ghost-button compact-button" onClick={onOpenNotifications}>
